...
export default function DeleteBlogModal({ isOpen, onClose, onConfirm, blogTitle }) {
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 p-6 relative z-10 animate-scale-up">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-gray-600 mb-6">
            ¿Estás seguro que deseas eliminar el blog{" "}
            <span className="font-semibold text-blue1">"{blogTitle}"</span>?
